...
placeholder content — `Aubrey Sylvia`, a generic hero image, and so on.
...
> Replace every "Aubrey Sylvia" placeholder in this site with my name,
...
- [ ] Your name, replacing `Aubrey Sylvia` everywhere it appears.
